...
(
    ...
    CONSTRAINT `DataPlatformOrdersHeaderPartnerData_fk` FOREIGN KEY (`OrderID`, `PartnerFunction`, `BusinessPartner`) REFERENCES `data_platform_orders_header_partner_data` (`OrderID`, `PartnerFunction`, `BusinessPartner`),
