...
(
    ...
    `StStockConfirmationPlantBatchValidityEndDate`  date DEFAULT NULL,
    `ProductIsBatchManagedInStockConfirmationPlant` tinyint(1) DEFAULT NULL,
    `OrderIssuingQuantity`                          float(15) NOT NULL,
    `OrderReceivingQuantity                         float(15) NOT NULL,
    `OrderIssuingQuantityUnit`                      varchar(3) NOT NULL,
    `OrderReceivingQuantityUnit`                    varchar(3) NOT NULL,
    ...
    CONSTRAINT `DataPlatformOrdersItemDataStockConfirmationPlant_fk` FOREIGN KEY (`OrderID`, `StockConfirmationPartnerFunction`, `StockConfirmationBusinessPartner`, `StockConfirmationPlant`) REFERENCES `data_platform_orders_header_partner_plant_data` (`OrderID`, `PartnerFunction`, `BusinessPartner`, `Plant`),
    ...
    CONSTRAINT `DataPlatformOrdersItemDataProductionPlant_fk` FOREIGN KEY (`OrderID`, `ProductionPlantPartnerFunction`, `ProductionPlantBusinessPartner`, `ProductionPlant`) REFERENCES `data_platform_orders_header_partner_plant_data` (`OrderID`, `PartnerFunction`, `BusinessPartner`, `Plant`),
    CONSTRAINT `DataPlatformOrdersItemDataIssuingPlant_fk` FOREIGN KEY (`OrderID`, `IssuingPlantPartnerFunction`, `IssuingPlantBusinessPartner`, `IssuingPlant`) REFERENCES `data_platform_orders_header_partner_plant_data` (`OrderID`, `PartnerFunction`, `BusinessPartner`, `Plant`),
    CONSTRAINT `DataPlatformOrdersItemDataReceivingPlant_fk` FOREIGN KEY (`OrderID`, `ReceivingPlantPartnerFunction`, `ReceivingPlantBusinessPartner`, `ReceivingPlant`) REFERENCES `data_platform_orders_header_partner_plant_data` (`OrderID`, `PartnerFunction`, `BusinessPartner`, `Plant`),
